function getBotResponse(input) {
    ...
    else if (input == "What sort of memberships do you have?"){
            let t1="We have gold,silver,platinum memberships.What do you prefer?"
           return t1;
    }
    else if (input == "I need to know about the gold model"){
            let t1="The number of sessions is 3 and it costs about INR 2699"
           return t1;
    }
     else {
